...
* Meanwhile, when your referrals get Credited AGAT through Daily Mining, Purchasing or AGAT Staking, you will also get extra Credited AGAT as a reward.
...
* In this rule, each miner's T, A, and N values are different, depending on the total amount of Referral Credited AGAT you have mined (including Referral Daily Mining Bonus, Referral Purchase Bonus, and Referral Staking Bonus).  
* The more Referral AGAT (**RA** in short, which is the Credited AGAT mined with the help of your referrals, including the following Referral Mining Bonus, Referral Purchase Mining, and Referral Staking Mining) you receive, the more Credited AGAT you will mine for free.
...
* You can see the amount of AGAT rewarded for each product in Agates Store page.
...
* In this way, you can mine up to 5,000 AGAT coins.
...
* In this way, you can mine up to 5,000 AGAT coins from each referral.
...
## 4. Earning Guideline
### 4.1 Mining Reward
* This is a USDT reward only for miners who have recently mined enough AGAT coins.
...
* This is a USDT dividend only for AGAT holders who hold enough AGAT coins.
...
### 4.3 Promoting Bonus
* This is a USDT bonus only for promoters who invite new users for Agates Network.
* Promoting Bonus will be issued in the form of USDT, and the total bonus is exactly 20% of the total profit of the Agates Network project in the current country or region in the latest reward period (usually 1 week or 2 weeks).
  ...
  * When the Agates Network project does not have a local promotion team in the current country or region, the top 20 users who have obtained the most Referral AGAT (**RA** in short, which is the Credited AGAT mined with the help of your referrals, including the following Referral Mining Bonus, Referral Purchase Mining, and Referral Staking Mining) during the reward period are eligible to participate in the Promoting Bonus event.
* The USDT bonus amount received by each promoter is strictly proportional to the amount of Referral AGAT during the reward period.
